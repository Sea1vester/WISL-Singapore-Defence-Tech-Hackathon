...
The six auto-imported demo logs are Singapore missions (Lim Chu Kang survey, Seletar perimeter patrol, Hillview inspection) under `sdth-demo/fixtures/singapore/`, generated by the bundled telemetry simulator. The earlier GPS-warning, dropout, Orbiter, exercise and supplemental logs in `sdth-demo/fixtures/` stay on disk as synthetic copies but no longer auto-import.
